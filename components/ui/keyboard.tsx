...
export const Keypad = () => {
  return (
    <div className="h-full w-fit rounded-xl bg-neutral-900 p-1 shadow-lg ring-1 shadow-black/50 ring-white/10">
      {/* Function Row */}
      <Row>
        <Key
          keyCode="Escape"
  ...
  return (
    <div className={cn("rounded-[4px] p-[0.5px]", containerClassName)}>
      <button
        ...
        className={cn(
          "flex h-6 w-6 cursor-pointer items-center justify-center rounded-[3.5px] bg-neutral-800 shadow-[0px_0px_1px_0px_rgba(0,0,0,0.8),0px_1px_2px_0px_rgba(0,0,0,0.4),0px_1px_0px_0px_rgba(255,255,255,0.1)_inset] transition-transform duration-75 active:scale-[0.98]",
          isPressed &&
            "scale-[0.98] bg-neutral-700 shadow-[0px_0px_1px_0px_rgba(0,0,0,0.8),0px_1px_1px_0px_rgba(0,0,0,0.3),0px_1px_0px_0px_rgba(255,255,255,0.05)_inset]",
          className,
        )}
      >
        <div
          className={cn(
            "flex h-full w-full flex-col items-center justify-center text-[5px] text-neutral-300",
            childrenClassName,
          )}
        >
          {children}
